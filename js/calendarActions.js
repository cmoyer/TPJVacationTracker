...
var createDateSelections = function(vacationDays) {
    //first wipe out all of the exiting form because the user may have made a new selection
    document.getElementById('myForm').innerHTML = '';


    // For all dates in the array, create a new row with a radio
    // button to select Full Day, Morning, or Afternoon.

    var arrayLength = vacationDays.length;
    ...
    for (var j = 0; j < arrayLength; j++){
        ...
        var currDate = vacationDays[j];
        var formattedDate = dateFormat(currDate, "fullDate");
    ...
    document.getElementById("myForm").appendChild(tbody);
